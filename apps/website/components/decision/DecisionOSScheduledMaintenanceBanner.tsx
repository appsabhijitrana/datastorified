...
export function DecisionOSScheduledMaintenanceBanner({ message }: { message: string }) {
  return (
    <div className="border-b border-border bg-soft/40 px-4 py-3 sm:px-6" role="status" aria-live="polite">
