...
export const decisionProfileSchema = z.object({
  ...
  incomeRange: z.string().trim().min(1).max(32).optional(),
  riskComfort: z.enum(["low", "moderate", "balanced", "growth", "high"]).optional(),
  careerStage: z.enum(["student", "early_career", "mid_career", "senior", "business_owner", "retired"]).optional(),
  homeOwnership: z.enum(["renting", "owning", "planning", "prefer_not_to_say"]).optional(),
